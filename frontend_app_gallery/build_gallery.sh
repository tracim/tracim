...
cp dist/gallery.app.js ../frontend/dist/app/gallery.app.js  && loggood "success" || logerror "some error"
...
cp i18next.scanner/pt/translation.json ../frontend/dist/app/gallery_de_translation.json && loggood "success" || logerror "some error"
