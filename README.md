...
Note: In case you do not want or can not install (for example, if you are using arm64) some preview based dependencies,
 like libreoffice, inkscape, ffmpeg, vtk, etc... You can install with the minimal preview dependencies requirements,
 which mean less working preview but also less problem in specific environnement:
