...
if [ "$mode" = "cypress" ]; then
    ...
    # Note that setting content_security_policy.additional_directives in development.ini
    # won't take effect as it will be overwritten by this declaration
    export TRACIM_CONTENT_SECURITY_POLICY__ADDITIONAL_DIRECTIVES="script-src 'unsafe-eval'"
