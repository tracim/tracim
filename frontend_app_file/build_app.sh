...
cp i18next.scanner/pt/translation.json ../frontend/dist/app/file_pt_translation.json && loggood "success" || logerror "some error"
log "copying de translation.json"
cp i18next.scanner/de/translation.json ../frontend/dist/app/file_de_translation.json && loggood "success" || logerror "some error"
