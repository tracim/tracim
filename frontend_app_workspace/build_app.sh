...
if [ "$only_utils" != "--only-utils" ]; then
    ...
    cp dist/workspace.app.optimized.js ../frontend/dist/app/workspace.app.optimized.js && loggood "success" || logerror "some error"
fi
...
cp i18next.scanner/pt/translation.json ../frontend/dist/app/workspace_pt_translation.json && loggood "success" || logerror "some error"
log "copying de translation.json"
cp i18next.scanner/de/translation.json ../frontend/dist/app/workspace_de_translation.json && loggood "success" || logerror "some error"
