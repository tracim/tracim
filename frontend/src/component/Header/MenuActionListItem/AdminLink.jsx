  ...
  return (
    <li className='header__menu__rightside__adminlink'>
      <div className='adminlink dropdown'>
        <button className='adminlink__btn btn primaryColorBorder primaryColorBgHover primaryColorBorderDarkenHover dropdown-toggle' type='button' data-toggle='dropdown'>
          Administration
        </button>
