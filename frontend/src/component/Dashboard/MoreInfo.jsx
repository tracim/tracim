...
export const MoreInfo = props =>
  <div className='moreinfo'>
    <div className='moreinfo__webdav genericBtnInfoDashboard'>
      <div
        className='moreinfo__webdav__btn moreinfoBtn genericBtnInfoDashboard__btn primaryColorBgHover primaryColorBorderDarkenHover'
    ...
    <div className='moreinfo__calendar genericBtnInfoDashboard'>
      <div className='moreinfo__calendar__wrapperBtn'>
        <div
          className='moreinfo__calendar__btn genericBtnInfoDashboard__btn moreinfoBtn genericBtnInfoDashboard__btn primaryColorBgHover primaryColorBorderDarkenHover'
