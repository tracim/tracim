...
const DropdownCreateButton = props => {
  return (
    <div className={classnames(props.parentClass, props.customClass, 'dropdownCreateBtn')}>
      <button
        className={classnames(`${props.parentClass}__label`, 'dropdownCreateBtn__label btn primaryColorBg primaryColorBorderDarkenHover primaryColorBgDarkenHover dropdown-toggle')}
        type='button'
