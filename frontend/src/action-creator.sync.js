...
export const WORKSPACE_ACTIVITY_LIST = `${WORKSPACE}/ActivityList`
export const setWorkspaceActivityList = activityList => ({ type: `${SET}/${WORKSPACE_ACTIVITY_LIST}`, activityList })
