    ...
    switch (fetchPostResetPassword.status) {
      ...
      case 400:
        switch (fetchPostResetPassword.json.code) {
          ...
          case 2061: props.dispatch(newFlashMessage(props.t('This username is not linked to any email, contact an administrator to reset your password'), 'warning')); break // TODO use the correct code which will be given by the backend/
