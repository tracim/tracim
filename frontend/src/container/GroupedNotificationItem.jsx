...
function getGroupedNotificationDetails (props, notification) {
  const { getNotificationDetails, t } = props
...
function handleClickGroupedNotification (props, e, notification) {
...
const GroupedNotificationItem = props => {
  const { notification, user } = props
  const notificationDetails = getGroupedNotificationDetails(props, notification)
  ...
  return (
    <Link
      ...
      onClick={(e) => handleClickGroupedNotification(props, e, notification)}
