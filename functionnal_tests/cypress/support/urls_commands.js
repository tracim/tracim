...
const URLS = {
  ...
  [PAGES.SEARCH]: ({searchedKeywords, pageNumber, numberByPage, actived, deleted, contentTypes}) => `/ui/search-result?act=${actived}&del=${deleted}&nr=${numberByPage}&p=${pageNumber}&q=${searchedKeywords}&t=${contentTypes}`,
