...
- [MIT](https://opensource.org/licenses/MIT) for the [backend](./backend/), functional tests, docker recipes, documentation, etc.
- [CC-BY-SA](https://creativecommons.org/licenses/by-sa/4.0/) for the provided welcome page background images. They are Copyright (c) Guénael Muller.aaa
...
You can find every license in the [licences folder](docs/_assets/licences).
