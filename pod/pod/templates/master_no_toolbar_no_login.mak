                ...
                <ul class="nav navbar-nav navbar-left">
                    ...
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        <li><a href="${tg.url('/users')}">${POD.ICO(16, 'apps/system-users')} ${_('Users')}</a></li>
                        <li><a href="${tg.url('/workspaces')}">${POD.ICO(16, 'places/folder-remote')} ${_('Workspaces')}</a></li>
                        <li class="divider" role="presentation"></li>
                        <li><a href="${tg.url('/configuration')}">${POD.ICO(16, 'categories/preferences-system')} ${_('Global configuration')}</a></li>
                      </ul>
                    </li>
                    ...
                    % if request.identity:
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu pull-right">
                                <li>
                                  <a href="${tg.url('/me')}">${POD.ICO(16, 'actions/contact-new')|n} ${_('My account')}</a>
                                </li>
                                <li class="divider" role="presentation"></li>
                                <li>
