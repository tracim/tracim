...
<%namespace name="TOOLBAR" file="pod.templates.thread_toolbars"/>
...
<%def name="REQUIRED_DIALOGS()">
    ${POD.MODAL_DIALOG('thread-edit-modal-dialog', 'modal-lg')}
</%def>
...
<h1 class="page-header">
    ${POD.ICO(32, result.thread.icon)} ${result.thread.label}
