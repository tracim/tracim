...
<div class="container-fluid">
    <div class="row-fluid">
        ...
        <div>
            <div class="row">
                <h3 class="col-sm-11">${POD.ICO(32, 'actions/contact-new')} ${result.user.name}</h3>
            </div>
            <div class="row">
                    ...
                    <div class="well well-sm">
                        ...
                        <p>
                            % if result.user.profile.id>=2:
                                <span>${POD.ICO(16, 'emblems/emblem-checked')} ${_('This user can create workspaces.')}</span><br/>
                            % endif
                            % if fake_api.current_user.profile.id>=3:
                                <span>${POD.ICO(16, 'emblems/emblem-checked')} ${_('This user is an administrator.')}</span><br/>
                            % endif
                        </p>
                    </div>
                </div>
