...
- By default, EPS previews are now disabled for security reasons, unless you manually enabled them. ([see preview generator documentation](https://github.com/algoo/preview-generator#eps-support))
