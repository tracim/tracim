...
class TestConfigEndpoint(object):
    ...
    def test_api__get_config__ok_200__nominal_case(self, web_testapp):
        ...
        assert res.json_body["ui__notes__code_sample_languages"] == [
            {"code": "markup", "display": "Markup"},
            {"code": "css", "display": "CSS"},
            {"code": "clike", "display": "C-like"},
            {"code": "javascript", "display": "JavaScript"},
            {"code": "apacheconf", "display": "Apache Configuration"},
            {"code": "arduino", "display": "Arduino"},
            {"code": "aspnet", "display": "ASP.NET"},
            {"code": "bash", "display": "Bash"},
            {"code": "batch", "display": "Batch"},
            {"code": "bbcode", "display": "BBcode"},
            {"code": "c", "display": "C"},
            {"code": "csharp", "display": "C#"},
            {"code": "cpp", "display": "C++"},
            {"code": "cobol", "display": "COBOL"},
            {"code": "css-extras", "display": "CSS Extras"},
            {"code": "csv", "display": "CSV"},
            {"code": "diff", "display": "Diff"},
            {"code": "django", "display": "Django/Jinja2"},
            {"code": "docker", "display": "Docker"},
            {"code": "erlang", "display": "Erlang"},
            {"code": "excel-formula", "display": "Excel Formula"},
            {"code": "fortran", "display": "Fortran"},
            {"code": "git", "display": "Git"},
            {"code": "haskell", "display": "Haskell"},
            {"code": "ignore", "display": ".ignore"},
            {"code": "ini", "display": "Ini"},
            {"code": "java", "display": "Java"},
            {"code": "jq", "display": "JQ"},
            {"code": "json", "display": "JSON"},
            {"code": "json5", "display": "JSON5"},
            {"code": "jsonp", "display": "JSONP"},
            {"code": "latex", "display": "LaTeX"},
            {"code": "lisp", "display": "Lisp"},
            {"code": "lua", "display": "Lua"},
            {"code": "makefile", "display": "Makefile"},
            {"code": "markdown", "display": "Markdown"},
            {"code": "matlab", "display": "MATLAB"},
            {"code": "nginx", "display": "nginx"},
            {"code": "objectivec", "display": "Objective-C"},
            {"code": "ocaml", "display": "OCaml"},
            {"code": "pascal", "display": "Pascal"},
            {"code": "perl", "display": "Perl"},
            {"code": "php", "display": "PHP"},
            {"code": "phpdoc", "display": "PHPDoc"},
            {"code": "php-extras", "display": "PHP Extras"},
            {"code": "powershell", "display": "PowerShell"},
            {"code": "properties", "display": ".properties"},
            {"code": "python", "display": "Python"},
            {"code": "r", "display": "R"},
            {"code": "jsx", "display": "React JSX"},
            {"code": "tsx", "display": "React TSX"},
            {"code": "regex", "display": "Regex"},
            {"code": "ruby", "display": "Ruby"},
            {"code": "rust", "display": "Rust"},
            {"code": "sql", "display": "SQL"},
            {"code": "vbnet", "display": "VB.Net"},
