...
class TestWorkspaceEndpoint(FunctionalTest):
    ...
    def test_api__delete_workspace__ok_200__admin(self) -> None:
        ...
        assert isinstance(res.json, dict)
        assert 'code' in res.json.keys()
        assert res.json_body['code'] == ERROR_CODE_INSUFFICIENT_USER_ROLE_IN_WORKSPACE  # nopep8
        self.testapp.authorization = (
            'Basic',
            (
                'admin@admin.admin',
...
class TestWorkspaceMembersEndpoint(FunctionalTest):
    ...
    def test_api__create_workspace_member_role__err_400__nothing(self):
        ...
        assert isinstance(res.json, dict)
        assert 'code' in res.json.keys()
        assert res.json_body['code'] == ERROR_CODE_EMAIL_VALIDATION_FAILED
    ...
    def test_api__delete_workspace_member_role__err_400__simple_user(self):
        ...
        assert isinstance(res.json, dict)
        assert 'code' in res.json.keys()
        assert res.json_body['code'] == ERROR_CODE_INSUFFICIENT_USER_ROLE_IN_WORKSPACE
        # after
...
class TestWorkspaceContents(FunctionalTest):
    ...
    def test_api__post_content_create_generic_content__err_400__label_already_used(self) -> None:  # nopep8
        ...
        assert isinstance(res.json, dict)
        assert 'code' in res.json.keys()
        assert res.json_body['code'] == ERROR_CODE_CONTENT_LABEL_ALREADY_USED_THERE
