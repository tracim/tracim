...
class TestResetPasswordRequestEndpointMailSync(object):
    ...
    def test_api__reset_password_request__ok__nominal_case_email(
        self, web_testapp, mailhog
    ):
        params = {"email": "admin@admin.admin"}
        web_testapp.post_json(
            "/api/auth/password/reset/request", status=204, params=params
        )
    ...
    def test_api__reset_password_request__err_204__username_missing_email(
        self, user_api_factory, web_testapp, mailhog
    ):
        uapi = user_api_factory.get()
        profile = Profile.USER
    ...
    @pytest.mark.email_notification
    @pytest.mark.internal_auth
    def test_api__reset_password_request__err_204__user_not_exist(
        self, web_testapp, mailhog
    ):
...
class TestResetPasswordCheckTokenEndpoint(object):
    ...
    def test_api__reset_password_check_token__ok_204__nominal_case(
        ...
        web_testapp.post_json(
            "/api/auth/password/reset/token/check", status=204, params=params
        )
...
class TestResetPasswordModifyEndpoint(object):
    ...
    def test_api__reset_password_reset__ok_204__nominal_case(
        ...
        web_testapp.post_json(
            "/api/auth/password/reset/modify", status=204, params=params
        )
    ...
    @pytest.mark.email_notification
    @pytest.mark.unknown_auth
    def test_api__reset_password_reset__ok_204__unknown_auth(
        self, web_testapp, user_api_factory
    ):
        # create new user without auth (default is unknown)
        web_testapp.authorization = (
...
class TestResetPasswordInternalAuthDisabled(object):
    @pytest.mark.email_notification
    @pytest.mark.internal_auth
    def test_api__reset_password_request__err__internal_auth_not_activated(
        self, web_testapp
    ):
        params = {"email": "admin@admin.admin"}
        web_testapp.post_json(
    ...
    @pytest.mark.email_notification
    @pytest.mark.internal_auth
    def test_api__reset_password_check_token__err__internal_auth_not_activated(
        self, web_testapp
    ):
