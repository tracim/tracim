...
class CaldavAppFactory(object):
    ...
    def create_dir_tree(self, radicale_config: ConfigParser, app_config: CFG):
        ...
        user_dir = os.path.join(sub_dir_storage_path, app_config.CALDAV__RADICALE__CALENDAR_DIR, app_config.CALDAV__RADICALE__USER_SUBDIR)
        os.makedirs(user_dir, exist_ok=True)
        workspace_dir = os.path.join(sub_dir_storage_path, app_config.CALDAV__RADICALE__CALENDAR_DIR, app_config.CALDAV__RADICALE__WORKSPACE_SUBDIR)
    ...
    def _parse_additional_radicale_config(
        ...
        for param_name, value in radicales_params.items():
            ...
            main_section, sub_main_section, radicale_section, radicale_param_config = parameter_parts
