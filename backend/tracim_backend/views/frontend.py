...
BASE_CSP_DIRECTIVES = (
    (
        ...
        "script-src",
        "'nonce-{nonce}' {base_url}/assets/hugerte-dist-1.0.7/ {base_url}/assets/frappe-gantt-1.2.2/ {base_url}/app/ 'unsafe-eval' 'wasm-unsafe-eval'",
    ),
    ...
    def index(self, context, request: TracimRequest):
        ...
        return render_to_response(
            self._get_index_file_path(),
            {
                ...
                "excluded_notification_wall": app_config.WEB__NOTIFICATION_WALL__EXCLUDED,
                "included_notification_wall": app_config.WEB__NOTIFICATION_WALL__INCLUDED,
                "excluded_recent_activities": app_config.WEB__RECENT_ACTIVITIES__EXCLUDED,
                "included_recent_activities": app_config.WEB__RECENT_ACTIVITIES__INCLUDED,
                "csp_nonce": csp_nonce,
                "glob": self.glob,
