...
def upgrade():
    ...
    with op.batch_alter_table("users") as batch_op:
        batch_op.add_column(
            sa.Column("avatar", ReducedSizeUploadFileField(), nullable=True)
        )
        batch_op.add_column(
            sa.Column("cover", ReducedSizeUploadFileField(), nullable=True)
        )
        batch_op.add_column(
            sa.Column("cropped_avatar", ReducedSizeUploadFileField(), nullable=True)
        )
        batch_op.add_column(
            sa.Column("cropped_cover", ReducedSizeUploadFileField(), nullable=True)
        )
