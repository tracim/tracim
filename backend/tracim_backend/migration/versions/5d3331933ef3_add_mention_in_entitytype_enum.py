...
def replace_enum(table_name: str, column_name: str, from_enum: sa.Enum, to_enum: sa.Enum) -> None:
...
def upgrade() -> None:
    replace_enum("events", "entity_type", old_entity_type_enum, new_entity_type_enum)


def downgrade() -> None:
    replace_enum("events", "entity_type", new_entity_type_enum, old_entity_type_enum)
