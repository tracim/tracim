...
class RadicaleProxyController(Controller):
    ...
    def radicale_proxy__user_address_book(
        ...
        example: /addressbook/user/1/ to radicale path /addressbook/user/1/
        """
        path = request.app_config.RADICALE__USER_AGENDA_PATH_PATTERN.format(
    ...
    def radicale_proxy__user_agenda_subitems(
        ...
        """
        proxy user agenda
        example: /agenda/user/1/event.ics to radicale path /agenda/user/1/event.ics
        """
    ...
    def radicale_proxy__user_address_book_subitems(
        ...
        """
        proxy user agenda
        example: /addressbook/user/1/event.ics to radicale path /addressbook/user/1/event.ics
        """
    ...
    def radicale_proxy__user_resource(
        ...
        """
        proxy user agenda
        example: /caldav-cardav_user_1/ to radicale path /caldav-cardav_user_1/
        """
        ...
        return proxy.get_response_for_request(request, "/{}/".format(user_resource_dir_name))
    ...
    def radicale_proxy__user_resource_user_subitems(
        ...
        """
        proxy user agenda
        example: /caldav-cardav_user_1/user_1_addressbook/ to radicale path /caldav-cardav_user_1/user_1_addressbook/
        """
    ...
    def radicale_proxy__user_resource_workspace_subitems(
        ...
        """
        proxy user agenda
        example: /caldav-cardav_user_1/space_1_addressbook/ to radicale path /caldav-cardav_user_1/space_1_addressbook/
        """
        user_resource_dir_name = request.app_config.RADICALE__USER_RESOURCE_DIR_PATTERN.format(
            user_id=request.candidate_user.user_id
        )
    ...
    def radicale_proxy__workspace_agenda(
        ...
        example: /agenda/workspace/1/ to radicale path /agenda/workspace/1/
        """
    ...
    def radicale_proxy__workspace_agenda_subitems(
        ...
        """
        proxy workspace agenda
        example: /agenda/workspace/1/event.ics to radicale path /agenda/workspace/1/event.ics
        """
    ...
    def radicale_proxy__workspace_address_book(
        ...
        """
        proxy workspace agenda
        example: /addressbook/workspace/1.ics/ to radicale path /addressbook/workspace/1.ics/
        """
        path = request.app_config.RADICALE__WORKSPACE_AGENDA_PATH_PATTERN.format(
            resource_type_dir=request.app_config.RADICALE__ADDRESSBOOK_DIR,
            workspace_subdir=request.app_config.RADICALE__WORKSPACE_SUBDIR,
    ...
    def radicale_proxy__workspace_address_book_subitems(
        ...
        """
        proxy workspace agenda
        example: /addressbook/workspace/1.ics/blabla.ics to radicale path /addressbook/workspace/1.ics/blabla.ics
        """
        workspace_agenda_path = request.app_config.RADICALE__WORKSPACE_AGENDA_PATH_PATTERN.format(
            resource_type_dir=request.app_config.RADICALE__ADDRESSBOOK_DIR,
            workspace_subdir=request.app_config.RADICALE__WORKSPACE_SUBDIR,
    ...
    def bind(self, configurator: Configurator) -> None:
        ...
        configurator.add_route(
            ...
            "/caldav-cardav_user_{user_id:[0-9]+}{trailing_slash:[/]?}",
        )
        ...
        configurator.add_route(
            ...
            "/caldav-cardav_user_{user_id:[0-9]+}/user_{dest_user_id:[0-9]+}_{type}{trailing_slash:[/]?}",  # noqa: W605
        )
        configurator.add_view(
        ...
        configurator.add_route(
            ...
            "/caldav-cardav_user_{user_id:[0-9]+}/user_{dest_user_id:[0-9]+}_{type}/{sub_item:.*}",  # noqa: W605
        )
        configurator.add_view(
        ...
        configurator.add_route(
            ...
            "/caldav-cardav_user_{user_id:[0-9]+}/space_{workspace_id:[0-9]+}_{type}{trailing_slash:[/]?}",  # noqa: W605
        )
        configurator.add_view(
        ...
        configurator.add_route(
            ...
            "/caldav-cardav_user_{user_id:[0-9]+}/space_{workspace_id:[0-9]+}_{type}/{sub_item:.*}",  # noqa: W605
        )
        configurator.add_view(
        ...
        # user agenda
        configurator.add_route(
            "radicale_proxy__user_agenda", "/agenda/user/{user_id:[0-9]+}{trailing_slash:[/]?}",
        )
        configurator.add_view(
        ...
        configurator.add_route(
            ...
            "/agenda/user/{user_id:[0-9]+}/{sub_item:[^\/]+\.ics}{trailing_slash:[/]?}",  # noqa: W605
        )
        configurator.add_view(
        ...
        configurator.add_route(
            ...
            "/addressbook/user/{user_id:[0-9]+}{trailing_slash:[/]?}",
        )
        configurator.add_view(
        ...
        configurator.add_route(
            ...
            "/addressbook/user/{user_id:[0-9]+}/{sub_item:[^\/]+\.vcf}{trailing_slash:[/]?}",  # noqa: W605
        )
        configurator.add_view(
        ...
        configurator.add_route(
            ...
            "/agenda/workspace/{workspace_id:[0-9]+}{trailing_slash:[/]?}",
        )
        configurator.add_view(
        ...
        configurator.add_route(
            "radicale_proxy__workspace_x", "/agenda/workspace/{workspace_id:[0-9]+}/{sub_item:.*}",
        )
        configurator.add_view(
        ...
        configurator.add_route(
            ...
            "/addressbook/workspace/{workspace_id:[0-9]+}{trailing_slash:[/]?}",
        )
        configurator.add_view(
        ...
        configurator.add_route(
            ...
            "/addressbook/workspace/{workspace_id:[0-9]+}/{sub_item:.*}",
        )
        configurator.add_view(
