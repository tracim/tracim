...
function install_backend_system_dep {
    ...
    $SUDO apt install -y imagemagick libmagickwand-dev ghostscript libfile-mimeinfo-perl poppler-utils libimage-exiftool-perl qpdf && loggood "success" || logerror "some error"
