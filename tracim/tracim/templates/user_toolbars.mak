...
<%def name="USER(current_user, user)">
    ...
    <div id="sidebar-right" class="col-sm-1 col-md-1 col-sm-offset-11 sidebar" style="background-color: #FFF;">
        <div class="btn-group btn-group-vertical">
            ...
            %>
            <a title="${_('Edit current user')}" class="btn btn-default" data-toggle="modal" data-target="#user-edit-modal-dialog" data-remote="${user_edit_url}" >${TIM.ICO(32, 'apps/accessories-text-editor')}</a>
