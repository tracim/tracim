...
<div class="row">
    ...
    <div class="col-sm-3">
        <div>
        <h2>${_('We suggest...')}</h2>
        <p>${TIM.ICO(32, 'actions/go-home')} <strong><a href="${tg.url('/')}">${_('to go back to the home page')}</a></strong></p>
        <p>${TIM.ICO(32, 'apps/internet-mail')} <strong><a href="mailto:support@trac.im">${_('to contact the support')}</a></strong></p>
    </div>
</div>
<div class="row">
