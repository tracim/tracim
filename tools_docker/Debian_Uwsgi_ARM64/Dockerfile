...
ARG PACKAGE_DIR
# Specific ARM64 requirements to disable VTK support
COPY optional_preview_packages_ARM64.list /tracim/system_packages/debian/optional_preview_packages.list
...
CMD ["/bin/bash","/tracim/tools_docker/Debian_Uwsgi_ARM64/entrypoint.sh"]
