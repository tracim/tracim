...
See [manual_setup](/docs.legacy/development/backend/setup/manual_setup.md).
...
documentation [here](/docs.legacy/administration/exploitation/cli.md)
...
This is also true in the Tracim REST API. You can check the [role documentation](/docs.legacy/overview/roles.md) to
check what a specific user can do.

## Other Documentation

Detailed documentation on several topics is available in the [development](/docs.legacy/development) directory.
