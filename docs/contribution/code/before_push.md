...
Run backend tests.  
See [testing backend](/docs/contribution/code/tests_for_backend.md).

### Translation

Generate backend translation files.  
See [i18n-backend](/docs.legacy/development/i18n/i18n-backend.md).
...
See [testing frontend](/docs/contribution/code/tests_for_frontend.md).
...
More information in [i18n-frontend](/docs.legacy/development/i18n/i18n-frontend.md).
