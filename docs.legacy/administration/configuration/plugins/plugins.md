...
Official plugins are provided with tracim. For more information, see the [official plugin documentation](/docs.legacy/administration/configuration/plugins/official_backend_plugins.md).
...
*NOTE: This code is also available
in [hello_world_plugin.py](/docs.legacy/administration/configuration/plugins/hello_world_plugin.py).*
```python
"""
