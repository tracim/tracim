...
This guide uses a docker compose and some configuration available in [minio-encryption.md](/docs.legacy/administration/configuration/storage/minio-encryption.md).
