...
These parameters can also be changed with environment variables as described in [settings_main_topics.md](/docs.legacy/administration/installation/settings_main_topics.md).
...
These parameters can also be changed with an environment variable as described in [settings_main_topics.md](/docs.legacy/administration/installation/settings_main_topics.md).
...
The paths of the files in `development.ini` are relative to `<branding_folder>`.
These parameters can also be changed with an environment variable as described in [setting.md](/docs.legacy/administration/installation/setting.md).
