...
See [BETA_testing_tracim_with_shibboleth_idp_in_docker.md](/docs.legacy/administration/installation/BETA_testing_tracim_with_shibboleth_idp_in_docker.md)
...
Don't forget to start mail_fetcher daemon, documentation here [Backend advanced setup](/docs.legacy/development/advanced/backend_server_setup.md)
...
to know more about this feature](/docs.legacy/administration/configuration/customisation/user_custom_properties.md).
