...
over the network, see [configuration file documentation](/docs.legacy/administration/installation/settings_main_topics.md).
...
Initialize the database using the [tracimcli](/docs.legacy/administration/exploitation/cli.md) tool. Be careful, if you use
...
See [official plugins documentations](/docs.legacy/administration/configuration/plugins/official_backend_plugins.md).
...
- configuration doc: [backend setting documentation](/docs.legacy/administration/installation/settings_main_topics.md)
...
Follow setup for [live messages](/docs.legacy/development/backend/setup/live_message_setup.md)
